...
public class PyorailijaTilasto {
    ...
    public Map<String, Integer> pyorailijoitaKuukausittain(String paikka) {
        ...
        rivit.stream().map(merkkijono -> merkkijono.split(";")).filter(taulukko -> taulukko.length > 10)
                .forEach(taulukko -> {
    ...
    private String merkkijonoKuukaudenNumeroksi(String kuukausi) {
        List<String> kuukaudet = Arrays.asList("tammi", "helmi", "maalis", "huhti", "touko", "kesä", "heinä", "elo",
