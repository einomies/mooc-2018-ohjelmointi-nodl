...
@Points("11-17.1 11-17.2 11-17.3 11-17.4")
public class MakihyppyTest {

    String klassName = "makihyppy.Main";
    ...
    public void luokkaJulkinen() {
        assertTrue("Pakkauksessa makihyppy sijaitsevan luokan Main pitää olla julkinen, eli se tulee määritellä\npackage makihyppy;\n\npublic class Main {...\n}", klass.isPublic());
    }
