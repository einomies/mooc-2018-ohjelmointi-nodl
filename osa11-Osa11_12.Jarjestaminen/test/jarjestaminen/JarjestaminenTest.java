...
public class JarjestaminenTest {
    ...
    String klassName = "jarjestaminen.Valintajarjestaminen";
    ...
    private void noForbiddens() {
        try {
            Scanner lukija = new Scanner(new File("src/jarjestaminen/Valintajarjestaminen.java"));
            while (lukija.hasNext()) {
                ...
                if (rivi.contains("Collections.sort(")) {
                    fail("Koska nyt harjoitellaan järjestämisalgoritmin kirjoittamista, "
                            + "et saa käyttää ohjelmassasi komentoa Collections.sort()");
                }
