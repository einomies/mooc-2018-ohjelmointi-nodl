...
public class Kortti {
    ...
    public boolean onNumerokortti() {
        return this.korttityyppi.equals("Numero");
    }

    public void setKorttityyppi(String korttityyppi) {
		this.korttityyppi = korttityyppi;
	}
	...
	public boolean onVarikortti() {
        return this.vari.equalsIgnoreCase("Keltainen")
        		|| this.vari.equalsIgnoreCase("Punainen")
        		|| this.vari.equalsIgnoreCase("Sininen")
        		|| this.vari.equalsIgnoreCase("Vihreä");
    }
