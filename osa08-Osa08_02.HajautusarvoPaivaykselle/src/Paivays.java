...
public class Paivays {
    ...
    /*
    Lisää Paivays-luokkaan metodi public int hashCode(), joka laskee päiväys-oliolle
    hajautusarvon. Toteuta hajautusarvon laskeminen siten, että vuosien 1900 ja 2100
    välillä löytyy mahdollisimman vähän samankaltaisia hajautusarvoja.
     */
    @Override
    public int hashCode() {
        int hash = 3;
