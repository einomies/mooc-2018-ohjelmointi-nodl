...
public class B_MatkalaukkuTest<_Tavara, _Matkalaukku> {
    ...
    String klassName = "tavarat.Matkalaukku";
    ...
    public void tarkistaLisaaTavaranToiminta() {
        try {
            ...
            Method lisaaTavaraMeto = ReflectionUtils.requireMethod(matkalaukkuClass, "lisaaTavara", ReflectionUtils.findClass("tavarat.Tavara"));
    ...
    public void tulostaTavaratTulostaaOikein() {
        ...
        try {
            ...
            Class tavara = ReflectionUtils.findClass("tavarat.Tavara");
