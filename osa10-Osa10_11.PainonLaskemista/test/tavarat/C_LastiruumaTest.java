...
import static tavarat.TestUtils.*;

@Points("10-11.1 10-11.2")
public class C_LastiruumaTest<_Tavara, _Matkalaukku, _Lastiruuma> {
    ...
    String klassName = "tavarat.Lastiruuma";
    ...
    @Before
    public void setup() {
        _MatkalaukkuRef = Reflex.reflect("tavarat.Matkalaukku");
        _TavaraRef = Reflex.reflect("tavarat.Tavara");
        _LastiruumaRef = Reflex.reflect("tavarat.Lastiruuma");

        try {
            tavaraClass = ReflectionUtils.findClass("tavarat.Tavara");
            ...
            matkalaukkuClass = ReflectionUtils.findClass("tavarat.Matkalaukku");
            matkalaukkuConstructor = ReflectionUtils.requireConstructor(matkalaukkuClass, int.class);

            lastiruumaClass = ReflectionUtils.findClass("tavarat.Lastiruuma");
    ...
    public void tarkistaTulostus() {
        try {
            ...
            Method toString = ReflectionUtils.requireMethod(ReflectionUtils.findClass("tavarat.Lastiruuma"), "toString");
    ...
    public void lastiruumaTarkistaTulostus() {
        ...
        try {
            ...
            Method m = ReflectionUtils.requireMethod(ReflectionUtils.findClass("tavarat.Lastiruuma"), "tulostaTavarat");
    ...
    private void lisaaRuumaan(Object ruuma, Object laukku) {
        try {
            Method lisaaRuumaanMeto = ReflectionUtils.requireMethod(ReflectionUtils.findClass("tavarat.Lastiruuma"), "lisaaMatkalaukku", ReflectionUtils.findClass("tavarat.Matkalaukku"));
    ...
    private void lisaaLaukkuun(Object laukku, Object tavara) {
        try {
            Method lisaaTavaraMeto = ReflectionUtils.requireMethod(ReflectionUtils.findClass("tavarat.Matkalaukku"), "lisaaTavara", ReflectionUtils.findClass("tavarat.Tavara"));
