...
public class OpiskelijaTest {
    ...
    String klassName = "opiskelijat.Opiskelija";
    ...
    public void setUp() {
        ...
        try {
            opiskelijaClass = ReflectionUtils.findClass("opiskelijat.Opiskelija");
        } catch (Throwable t) {
            fail("Onhan tehtävässä luokka \"Opiskelija\" ja onhan se pakkauksessa opiskelijat?");
        }
    }
